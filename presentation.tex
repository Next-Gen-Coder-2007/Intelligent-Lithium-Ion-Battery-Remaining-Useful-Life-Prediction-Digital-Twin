...
\setbeamertemplate{footline}{
  ...
  \begin{beamercolorbox}[wd=.333333\paperwidth,ht=2.25ex,dp=1ex,center]{title in head/foot}%
    \usebeamerfont{title in head/foot}Project Review 1: Phase 1 ML Benchmark
  \end{beamercolorbox}%
  ...
  \begin{column}{0.5\textwidth}
    \begin{block}{\textbf{Key Technical Accomplishments}}
      ...
      \begin{enumerate}
        ...
        \item \textbf{GPU Acceleration}: Deployed NVIDIA CUDA GPU for tree boosting and multi-core CPU parallelization.
        ...
        \item \textbf{Secondary Pipeline}: Implemented feature extraction for the official NASA PCoE 4-cell repository.
      \end{enumerate}
    \end{block}
  \end{column}
