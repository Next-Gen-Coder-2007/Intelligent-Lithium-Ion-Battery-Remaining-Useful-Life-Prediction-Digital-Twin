...
\definecolor{PillBg}{RGB}{224, 242, 254}        % #E0F2FE
...
\subtitle{Data-Driven Machine Learning Pipeline, 5-Fold Cross-Validation, and Multi-Model Optimization}
...
% ------------------------------------------------------------------------------
% SLIDE 1: PREMIUM ACADEMIC TITLE SLIDE
% ------------------------------------------------------------------------------
\begin{frame}[plain]
  \vspace{0.2em}
  ...
  \begin{center}
    \begin{tikzpicture}
      \fill[NavyPrimary] (0,0) rectangle (7.5, 0.06);
      \fill[TealSecondary] (7.5,0) rectangle (14.0, 0.06);
    \end{tikzpicture}
  \end{center}
  \vspace{-0.3em}
  ...
  \begin{center}
    {\fontsize{15pt}{18pt}\selectfont \textbf{\textcolor{NavyPrimary}{Intelligent Lithium-Ion Battery Remaining Useful Life Prediction Digital Twin}}}\\[0.3em]
    {\fontsize{10.5pt}{13pt}\selectfont \textbf{\textcolor{TealSecondary}{Data-Driven Machine Learning Pipeline, 5-Fold Cross-Validation, and Multi-Model Optimization}}}\\[0.6em]
    
    % Group Pill Badge & Department Banner
    \begin{tikzpicture}
      \node[fill=NavyPrimary, text=white, rounded corners=3pt, font=\scriptsize\bfseries, inner sep=3.5pt] at (0,0) {GROUP NO: 11};
      \node[text=DarkSlate, font=\scriptsize\bfseries, right=0.3cm of current bounding box.east] {Department of Machine Learning \& Data Science};
    \end{tikzpicture}
  \end{center}
  \vspace{-0.2em}

  % Team Members & Project Metadata Cards
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{beamercolorbox}[rounded=true,shadow=false,wd=\textwidth,sep=5pt]{block body}
        \textbf{\textcolor{NavyPrimary}{\scriptsize TEAM MEMBERS (1 -- 3):}}\\[0.25em]
        \scriptsize
        \begin{tabular}{@{}ll@{}}
    ...
    \begin{column}{0.48\textwidth}
      \begin{beamercolorbox}[rounded=true,shadow=false,wd=\textwidth,sep=5pt]{block body}
        \textbf{\textcolor{NavyPrimary}{\scriptsize TEAM MEMBERS (4 -- 5) \& DOMAIN:}}\\[0.25em]
        \scriptsize
        \begin{tabular}{@{}ll@{}}
          \textbf{4.} Team Member 4     & \textbf{Roll No:} 22A91A0504 \\
          \textbf{5.} Team Member 5     & \textbf{Roll No:} 22A91A0505 \\[0.15em]
          \multicolumn{2}{@{}l}{\textbf{Project Domain:} AI \& Energy Storage Systems} \\
        \end{tabular}
      \end{beamercolorbox}
    \end{column}
  \end{columns}
  ...
  \vspace{0.4em}
  % Bottom Methodology Scope Band
  \begin{center}
    \begin{beamercolorbox}[rounded=true,shadow=false,wd=0.98\textwidth,center,sep=3pt]{block body alerted}
      \tiny \textcolor{DarkSlate}{\textbf{Methodology Scope:} 14,992 Degradation Cycles $\bullet$ 10-Model Empirical Benchmark $\bullet$ 5-Fold GridSearchCV Tuning $\bullet$ Diagnostic Error Envelopes}
    \end{beamercolorbox}
  \end{center}
\end{frame}
